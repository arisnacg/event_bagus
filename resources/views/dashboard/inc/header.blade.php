...
<<<<<<< HEAD
                    ...
                    @include('dashboard.inc.notif_box')
=======
                    {{-- @if($num_notif > 0)
                        <div class="notify">
                            <span class="heartbit"></span><span class="point"></span>
...
=======
                        <img src="{{ asset('img/user/'.Auth::user()->img_profile) }}" style="margin-right: 6px" class="profile-pic" />
>>>>>>> d864338e1c0a59fc61fa335e948029ff795a9fc1
                        {{ Auth::user()->name }}
...
<<<<<<< HEAD
                            ...
                            <li><a href="/change_password"><i class="ti-key"></i> Ganti Password</a></li>
=======
